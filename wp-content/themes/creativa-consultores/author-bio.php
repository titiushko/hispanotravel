...
<div class="author-bio clearfix">
	...
	<div class="col-md-9 col-sm-9 col-xs-12">
		<h3 class="author-name">
			<?php printf(__('About %s', 'creativa-consultores'), esc_html($author_name) ); ?>				
		</h3>
		...
		<div class="view-all"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php printf(__('See all posts by %s', 'creativa-consultores'), esc_html($author_name) ); ?></a>&nbsp;<i class="fa fa-long-arrow-right"></i></div>
	</div>
</div> 
