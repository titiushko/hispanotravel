...
function wpmm_do_display_map( $attr ) {
	...
	if ( 'null' != $stores ) {
		...
		wp_enqueue_script( 'data-feed-js', WPMM_URL . 'js/wpmm-static-ds.js', array( 'jquery', 'store-locator-js', 'maps-api-js', 'infobubble-js' ), '4.0' );
		...
		wp_enqueue_script( 'panel-js', WPMM_URL . 'js/panel.js', array( 'jquery', 'store-locator-js', 'maps-api-js', 'infobubble-js' ), '4.0'  );
		...
		return apply_filters('wpmm_map_shortcode_html', '<div id="wpmm-container"><div id="panel"></div><div id="map-canvas"></div></div>' );
	} else {
