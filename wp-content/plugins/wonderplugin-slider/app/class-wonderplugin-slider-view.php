		...
		else
		{
			...
			<?php } else { ?>
				...
				<tr>
					...
					<td><?php echo esc_html($key); ?> &nbsp;&nbsp;&nbsp;&nbsp;<input name="wonderplugin-slider-key" type="hidden" id="wonderplugin-slider-key" value="<?php echo esc_html($key); ?>" class="regular-text" /><input type="submit" name="deregister-slider-license" id="deregister-slider-license" class="button button-primary" value="Deregister the License Key"  /></label></td>
				</tr>
				</table>
				</form>
